...
import { ArrowLeft, Bath, Bed, Home, Mail, MapPin, Phone } from 'lucide-react';
...
export default function ListingDetail() {
  ...
  return (
    <div className="min-h-screen bg-warm-white pb-20">
      <div className="h-[58vh] min-h-[460px] relative bg-slate-200">
        <img
        ...
        <div className="absolute bottom-0 left-0 w-full p-6 md:p-12">
          <div className="max-w-[1440px] mx-auto">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              {listing.premium && (
                <span className="bg-deep-navy/80 backdrop-blur text-gold border border-gold/30 text-xs font-bold px-3 py-1 uppercase tracking-wider">
                  Premium Collection
                </span>
              )}
              <span className="text-white/80 font-mono text-sm ml-auto">REF: {listing.code}</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-montserrat font-light text-white mb-3 tracking-[0.04em]">{listing.title}</h1>
            <p className="text-lg md:text-xl text-slate-200 flex items-center gap-2 font-light">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-12">
            <section>
              <p className="text-gold font-bold text-[10px] uppercase tracking-[0.3em] mb-4">Property Overview</p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-deep-navy/10 border border-deep-navy/10 shadow-sm">
                ...
                <div className="flex flex-col items-center justify-center p-6 bg-white col-span-2">
            ...
            {listing.description && (
              <section>
                <h2 className="text-2xl font-montserrat text-deep-navy mb-6 uppercase tracking-[0.1em] font-light">Description</h2>
                <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed bg-white p-8 border border-deep-navy/10 shadow-sm">
            ...
            <section>
              <h2 className="text-2xl font-montserrat text-deep-navy mb-6 uppercase tracking-[0.1em] font-light">Location</h2>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-28 bg-deep-navy text-white p-8 shadow-xl border border-gold/20">
              ...
              <div className="pt-8 border-t border-white/10">
                ...
                <Link
                  ...
                  className="block w-full text-center bg-gold hover:bg-white hover:text-deep-navy text-white py-4 uppercase tracking-widest text-sm font-bold transition-colors shadow-lg"
                >
                  Schedule a Viewing
                </Link>
              </div>
